	...
	static Stream<org.junit.jupiter.params.provider.Arguments> printProvider() {
		return Stream
				.of(Arguments.of(null, NULL),
					...
					Arguments.of(new int[]{1, 2}, "قائمة: " + Arrays.toString(new int[]{1, 2})),
					Arguments.of(new long[]{1, 2}, "قائمة: " + Arrays.toString(new long[]{1, 2})),
					Arguments.of(new double[]{1, 2}, "قائمة: " + Arrays.toString(new double[]{1, 2})),
					Arguments.of(new float[]{1, 2}, "قائمة: " + Arrays.toString(new float[]{1, 2})),
