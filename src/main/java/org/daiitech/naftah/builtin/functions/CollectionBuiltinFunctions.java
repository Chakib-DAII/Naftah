...
public final class CollectionBuiltinFunctions {
	...
	@NaftahFn(  name = "هل_أصغر_أو_يساوي",
				...
				usage = """
						هل_أصغر_أو_يساوي({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "هل_أكبر_أو_يساوي",
				...
				usage = """
						هل_أكبر_أو_يساوي({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "جمع_عنصر_ب_عنصر",
				...
				usage = """
						جمع_عنصر_ب_عنصر({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "طرح_عنصر_ب_عنصر",
				...
				usage = """
						طرح_عنصر_ب_عنصر({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "ضرب_عنصر_ب_عنصر",
				...
				usage = """
						ضرب_عنصر_ب_عنصر({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "قسمة_عنصر_ب_عنصر",
				...
				usage = """
						قسمة_عنصر_ب_عنصر({a:1 , b:2} , {c:1 , d:2})
	...
	@NaftahFn(  name = "باقي_القسمة_عنصر_ب_عنصر",
				...
				usage = """
						باقي_القسمة_عنصر_ب_عنصر({a:1 , b:2} , {c:1 , d:2})
	...
	private static <T> void checkParams(T x, T y) {
		if (!(CollectionUtils.isCollectionMapOrArray(x) || CollectionUtils.isCollectionMapOrArray(y))) {
			throw new NaftahBugError("يجب أن يكون على الأقل أحد المعاملين مصفوفة أو مجموعة أو خريطة.");
		}
	}
	...
	private static <T> void checkParam(T x) {
		if (!CollectionUtils.isCollectionMapOrArray(x)) {
			throw new NaftahBugError("يجب أن يكون المعامل مصفوفة أو مجموعة أو خريطة.");
