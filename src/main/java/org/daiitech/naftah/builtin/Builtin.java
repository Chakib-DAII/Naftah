...
@NaftahFnProvider(name = "مزوّد دوال مدمجة",
				  description = "يحتوي هذا الموفر على دوال مدمجة تُستخدم ضمن لغة نفطه لأداء عمليات حسابية ومنطقية " +
						  "مختلفة بدقة وكفاءة.",
...
public final class Builtin {
	...
	@NaftahFn(name = "إطبع",
			  ...
			  description = "تعليمة الطباعة (إطبع) هي التعليمة التي تُستخدم في البرمجة لإظهار نص معين على الشاشة، مثل "
	 ...
	 */
	@NaftahFn(name = "إجمع",
			  description = "إضافة الأعداد معًا للحصول على مجموع. هو العملية الأساسية التي تُستخدم في الرياضيات " +
					  "لتحديد" + " القيمة الإجمالية من خلال جمع عدة أرقام.",
			  usage = "إجمع(ش ، ي)",
	 ...
	 */
	@NaftahFn(name = "إطرح",
			  description = "طرح الأعداد للحصول على الفرق. هو العملية الأساسية التي تُستخدم في الرياضيات لتحديد " +
					  "القيمة" + " المتبقية عند إزالة قيمة عدد من عدد آخر.",
			  usage = "إطرح(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	 ...
	 */
	@NaftahFn(name = "إضرب",
			  description = "ضرب الأعداد للحصول على الناتج هو العملية الأساسية التي تُستخدم في الرياضيات لتحديد " +
					  "القيمة" + " الإجمالية عند تكرار جمع عدد معين عدة مرات.",
			  usage = "إضرب(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	 ...
	 */
	@NaftahFn(name = "إقسم",
			  description = "قسمة الأعداد للحصول على خارج القسمة هي العملية الأساسية التي تُستخدم في الرياضيات لتحديد "
					  + "كم مرة يمكن تقسيم عدد إلى أجزاء متساوية.",
			  usage = "إقسم(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	...
	@NaftahFn(name = "باقي_القسمة",
			  description =
					  "عملية باقي القسمة (المودولو) هي العملية التي تُستخدم في الرياضيات لتحديد الباقي المتبقي " +
							  "بعد قسمة عدد على عدد آخر.",
	...
	@NaftahFn(name = "الأكبر",
			  description = "دالة (الأكبر) تُستخدم لمقارنة عددين وإرجاع العدد الأكبر بينهما. تُفيد هذه العملية في " +
					  "تحديد القيمة العليا عند المفاضلة بين قيمتين عدديتين.",
			  usage = "الأكبر(ش ، ي)",
	...
	@NaftahFn(name = "الأصغر",
			  description = "دالة (الأصغر) تُستخدم لمقارنة عددين وإرجاع العدد الأصغر بينهما. تُفيد هذه العملية في " +
					  "تحديد القيمة الدنيا عند المفاضلة بين قيمتين عدديتين.",
			  usage = "الأصغر(ش ، ي)",
			  parameterTypes = {Number.class, Number.class},
			  returnType = Number.class)
	 ...
	 */
	@NaftahFn(name = "إرفع",
			  description = "دالة (إرفع) تُستخدم لرفع عدد (الأساس) إلى قوة عدد صحيح (الأس). تُفيد هذه العملية في " +
					  "الحسابات الرياضية التي تتطلب التكرار الأسي مثل حساب المربعات أو المكعبات.",
	...
	@NaftahFn(name = "تقريب",
			  description =
					  "دالة (تقريب) تُستخدم لتقريب عدد عشري إلى أقرب عدد صحيح. تُفيد هذه العملية في العمليات " +
							  "الحسابية التي تتطلب أعدادًا صحيحة دقيقة.",
			  usage = "تقريب(ش)",
	 ...
	 */
	@NaftahFn(name = "أرضي",
			  description = "دالة (أرضي) تُستخدم لإرجاع أكبر عدد صحيح أصغر من أو يساوي العدد المعطى. تُفيد هذه " +
					  "العملية" + " في العمليات الحسابية التي تتطلب تقريب الأعداد إلى الأسفل.",
			  usage = "أرضي(ش)",
			  parameterTypes = {Number.class},
			  returnType = Number.class)
	 ...
	 */
	@NaftahFn(name = "سقف",
			  description = "دالة (سقف) تُستخدم لإرجاع أصغر عدد صحيح أكبر من أو يساوي العدد المعطى. تُفيد هذه العملية "
					  + "في العمليات الحسابية التي تتطلب تقريب الأعداد إلى الأعلى.",
			  usage = "سقف(ش)",
			  parameterTypes = {Number.class},
			  returnType = Number.class)
	...
	@NaftahFn(name = "إنفي",
			  description =
					  "دالة (إنفي) تُستخدم لإرجاع العدد المعطى بعد تغييره إلى قيمته السالبة. تُفيد هذه العملية " +
							  "في" + " العمليات الحسابية التي تتطلب عكس الإشارة العددية.",
			  usage = "إنفي(ش)",
			  parameterTypes = {Number.class},
			  returnType = Number.class)
	 ...
	 */
	@NaftahFn(name = "جذر",
			  description = "دالة (جذر) تُستخدم لحساب الجذر التربيعي للعدد المعطى. تُفيد هذه العملية في العمليات " +
					  "الحسابية التي تتطلب إيجاد قيمة العدد الذي مربعه يساوي العدد الأصلي.",
			  usage = "جذر(ش)",
			  parameterTypes = {Number.class},
			  returnType = Number.class)
	...
	@NaftahFn(name = "إشارة",
			  description =
					  "دالة (إشارة) تُستخدم لتحديد إشارة العدد المعطى: ترجع -1 إذا كان العدد سالبًا، 0 إذا كان " +
							  "صفرًا، و1 إذا كان موجبًا.",
			  usage = "إشارة(ش)",
			  parameterTypes = {Number.class},
	...
	@NaftahFn(name = "هل_صفر",
			  description =
					  "دالة (هل_صفر) تُستخدم للتحقق مما إذا كان العدد المعطى يساوي صفرًا. تُرجع صحيح إذا كان " +
							  "العدد صفرًا، وخطأ خلاف ذلك.",
			  usage = "هل_صفر(ش)",
			  parameterTypes = {Number.class},
	...
	@NaftahFn(name = "هل_يساوي",
			  description = "دالة (هل_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كانا متساويين في القيمة. تُرجع " +
					  "صحيح" + " إذا كان العددان متساويين، وخطأ خلاف ذلك.",
			  usage = "هل_يساوي(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	...
	@NaftahFn(name = "هل_لا_يساوي",
			  description =
					  "دالة (هل_لا_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كانا غير متساويين في القيمة. " +
							  "تُرجع صحيح إذا كان العددان غير متساويين، وخطأ خلاف ذلك.",
	...
	@NaftahFn(name = "هل_أصغر_من",
			  description =
					  "دالة (هل_أصغر_من) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أصغر من العدد " +
							  "الثاني. تُرجع صحيح إذا كان الأول أصغر، وخطأ خلاف ذلك.",
	...
	@NaftahFn(name = "هل_أصغر_أو_يساوي",
			  description =
					  "دالة (هل_أصغر_أو_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أصغر أو " +
							  "يساوي العدد الثاني. تُرجع صحيح إذا كان الأول أصغر أو يساوي، وخطأ خلاف ذلك.",
	...
	@NaftahFn(name = "هل_أكبر_من",
			  description =
					  "دالة (هل_أكبر_من) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أكبر من العدد " +
							  "الثاني. تُرجع صحيح إذا كان الأول أكبر، وخطأ خلاف ذلك.",
	...
	@NaftahFn(name = "هل_أكبر_أو_يساوي",
			  description =
					  "دالة (هل_أكبر_أو_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أكبر أو " +
							  "يساوي العدد الثاني. تُرجع صحيح إذا كان الأول أكبر أو يساوي، وخطأ خلاف ذلك.",
	 ...
	 */
	@NaftahFn(name = "و_بتي",
			  description = "دالة (و_بتي) تُنفذ عملية 'AND' على الأعداد الثنائية (bitwise) المعطاة. تُرجع العدد " +
					  "الناتج" + " عن العملية الثنائية بين العددين.",
			  usage = "و_بتي(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	...
	@NaftahFn(name = "أو_بتي",
			  description = "دالة (أو_بتي) تُنفذ عملية 'OR' الثنائية على الأعداد المعطاة. تُرجع العدد الناتج عن تطبيق "
					  + "العملية الثنائية بين العددين.",
			  usage = "أو_بتي(ش ، ي)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	...
	@NaftahFn(name = "حصري_أو_بتي",
			  description = "دالة (حصري_أو_بتي) تُنفذ عملية 'XOR' الثنائية على الأعداد المعطاة. تُرجع العدد الناتج عن "
					  + "تطبيق العملية الثنائية الحصرية بين العددين.",
	...
	@NaftahFn(name = "ليس_بتي",
			  description = "دالة (ليس_بتي) تُنفذ عملية النفي الثنائي (bitwise NOT) على العدد المعطى. تُرجع العدد " +
					  "الناتج عن عكس كل بت في العدد.",
			  usage = "ليس_بتي(ش)",
			  parameterTypes = {Object.class, Object.class},
			  returnType = Object.class)
	...
	@NaftahFn(name = "إزاحة_إلى_اليسار",
			  description =
					  "دالة (إزاحة_إلى_اليسار) تُنفذ عملية إزاحة البتات للعدد المعطى إلى اليسار بعدد المواقع " +
							  "المحدد. تُستخدم هذه العملية في الحسابات الثنائية لتعظيم القيمة.",
	...
	@NaftahFn(name = "إزاحة_إلى_اليمين",
			  description =
					  "دالة (إزاحة_إلى_اليمين) تُنفذ عملية إزاحة البتات للعدد المعطى إلى اليمين بعدد المواقع " +
							  "المحدد. تُستخدم هذه العملية في الحسابات الثنائية لتقليل القيمة.",
	...
	@NaftahFn(name = "إزاحة_إلى_اليمين_غير_موقعة",
			  description =
					  "دالة (إزاحة_إلى_اليمين_غير_موقعة) تُنفذ عملية إزاحة البتات للعدد المعطى إلى اليمين بدون " +
							  "اعتبار الإشارة، بعدد المواقع المحدد. تُستخدم هذه العملية لمعالجة الأعداد بدون تأثير " + "الإشارة " + "السالبة.",
	...
	@NaftahFn(
			...
			description = "دالة (تحليل_رقم_بنظام_العد) لتحليل رقم نصي وفقًا للنظام العددي المحدد وإرجاع النوع " +
					"المناسب" + " " + "من" + " الأعداد.",
