...
public final class Builtin {
  ...
  @NaftahFn(
      name = "رفع",
      description =
          "دالة (رفع) تُستخدم لرفع عدد (الأساس) إلى قوة عدد صحيح (الأس). تُفيد هذه العملية في الحسابات الرياضية التي تتطلب التكرار الأسي مثل حساب المربعات أو المكعبات.",
      usage = "رفع(الأساس ، الأس)",
  ...
  @NaftahFn(
      name = "نفي",
      description =
          "دالة (نفي) تُستخدم لإرجاع العدد المعطى بعد تغييره إلى قيمته السالبة. تُفيد هذه العملية في العمليات الحسابية التي تتطلب عكس الإشارة العددية.",
      usage = "نفي(ش)",
      parameterTypes = {Number.class},
      returnType = Number.class)
  ...
  @NaftahFn(
      name = "هل_صفر",
      description =
          "دالة (هل_صفر) تُستخدم للتحقق مما إذا كان العدد المعطى يساوي صفرًا. تُرجع true إذا كان العدد صفرًا، وfalse خلاف ذلك.",
      usage = "هل_صفر(ش)",
      parameterTypes = {Number.class},
  ...
  @NaftahFn(
      name = "يساوي",
      description =
          "دالة (يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كانا متساويين في القيمة. تُرجع true إذا كان العددان متساويين، وfalse خلاف ذلك.",
      usage = "يساوي(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  public static <T> boolean equals(T x, T y) {
    try {
      ...
      if (bug.getBugText().equals("لا يمكن أن تكون الوسائط فارغة.")) throw bug;
      return x.equals(y);
    }
  }
  ...
  @NaftahFn(
      name = "لا_يساوي",
      description =
          "دالة (لا_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كانا غير متساويين في القيمة. تُرجع true إذا كان العددان غير متساويين، وfalse خلاف ذلك.",
      usage = "لا_يساوي(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "أصغر_من",
      description =
          "دالة (أصغر_من) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أصغر من العدد الثاني. تُرجع true إذا كان الأول أصغر، وfalse خلاف ذلك.",
      usage = "أصغر_من(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "أصغر_أو_يساوي",
      description =
          "دالة (أصغر_أو_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أصغر أو يساوي العدد الثاني. تُرجع true إذا كان الأول أصغر أو يساوي، وfalse خلاف ذلك.",
      usage = "أصغر_أو_يساوي(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "أكبر_من",
      description =
          "دالة (أكبر_من) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أكبر من العدد الثاني. تُرجع true إذا كان الأول أكبر، وfalse خلاف ذلك.",
      usage = "أكبر_من(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "أكبر_أو_يساوي",
      description =
          "دالة (أكبر_أو_يساوي) تُستخدم لمقارنة عددين والتحقق مما إذا كان العدد الأول أكبر أو يساوي العدد الثاني. تُرجع true إذا كان الأول أكبر أو يساوي، وfalse خلاف ذلك.",
      usage = "أكبر_أو_يساوي(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "و",
      description =
          "دالة (و) تُنفذ عملية 'AND' على الأعداد الثنائية (bitwise) المعطاة. تُرجع العدد الناتج عن العملية الثنائية بين العددين.",
      usage = "و(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "أو",
      description =
          "دالة (أو) تُنفذ عملية 'OR' الثنائية على الأعداد المعطاة. تُرجع العدد الناتج عن تطبيق العملية الثنائية بين العددين.",
      usage = "أو(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "حصري_أو",
      description =
          "دالة (حصري_أو) تُنفذ عملية 'XOR' الثنائية على الأعداد المعطاة. تُرجع العدد الناتج عن تطبيق العملية الثنائية الحصرية بين العددين.",
      usage = "حصري_أو(ش ، ي)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "ليس",
      description =
          "دالة (ليس) تُنفذ عملية النفي الثنائي (bitwise NOT) على العدد المعطى. تُرجع العدد الناتج عن عكس كل بت في العدد.",
      usage = "ليس(ش)",
      parameterTypes = {Object.class, Object.class},
      returnType = Object.class)
  ...
  @NaftahFn(
      name = "إزاحة_إلى_اليمين_غير_موقعة",
      description =
