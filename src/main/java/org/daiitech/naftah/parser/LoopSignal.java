...
public enum LoopSignal {
	 ...
	 *
	 * @param signal
	 *                    the control signal (must not be {@code null})
	 * @param sourceLabel
	 *                    label associated with the source of the signal, may be
	 *                    {@code null}
	 * @param targetLabel
	 *                    label indicating the intended target for the signal, may be
	 *                    {@code null}
	 * @param result
	 *                    optional result value to carry with the signal, may be
	 *                    {@code null}
	 */
	public record LoopSignalDetails(LoopSignal signal, String sourceLabel, String targetLabel, Object result) {
		 ...
		 *
		 * @param signal
		 *                    the control signal (non-null)
		 * @param sourceLabel
		 *                    the source label (may be {@code null})
		 * @param targetLabel
		 *                    the target label (may be {@code null})
		 * @param result
		 *                    the result object (may be {@code null})
