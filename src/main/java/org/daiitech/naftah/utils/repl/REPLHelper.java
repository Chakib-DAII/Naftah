...
public final class REPLHelper {
	...
	public static final String RTL_PROMPT = shouldReshape() ? shape(RTL_PROMPT_VALUE) : RTL_PROMPT_VALUE; // Right-to-left
																											// mark
																											// before
																											// prompt
	public static final String RTL_MULTILINE_PROMPT = shouldReshape() ? shape(RTL_MULTILINE_PROMPT_VALUE) : RTL_MULTILINE_PROMPT_VALUE; // Right-to-left multiline mark before prompt
	...
	public static LineReader getLineReader(Terminal terminal) {
		...
		// Complete with fixed lexer strings and loaded builtins and Vm classes and
		// functions
		try {
