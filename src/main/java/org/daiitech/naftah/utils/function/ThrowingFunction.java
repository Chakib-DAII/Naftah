...
/**
 * A {@link Function} that allows invocation of code that throws a checked exception.
 *
...
public interface ThrowingFunction<T, R> extends Function<T, R> {
  ...
  /**
   * Default {@link Function#apply(Object)} that wraps any thrown checked exceptions (by default in
  ...
  /**
   * Return a new {@link ThrowingFunction} where the {@link #apply(Object)} method wraps any thrown
   ...
   */
  default ThrowingFunction<T, R> throwing(
  ...
  /**
   * Lambda friendly convenience method that can be used to create a {@link ThrowingFunction} where
   * the {@link #apply(Object)} method wraps any checked exception thrown by the supplied lambda
  ...
  /**
   * Lambda friendly convenience method that can be used to create a {@link ThrowingFunction} where
   * the {@link #apply(Object)} method wraps any thrown checked exceptions using the given {@code
   * exceptionWrapper}.
   *
   * <p>This method can be especially useful when working with method references. It allows you to
   * easily convert a method that throws a checked exception into an instance compatible with a
   ...
   * @return a new {@link ThrowingFunction} instance
   */
  static <T, R> ThrowingFunction<T, R> of(
