...
/**
 * A {@link BiFunction} that allows invocation of code that throws a checked exception.
 *
...
public interface ThrowingBiFunction<T, U, R> extends BiFunction<T, U, R> {
  ...
  /**
   * Default {@link BiFunction#apply(Object, Object)} that wraps any thrown checked exceptions (by
   * default in a {@link RuntimeException}).
   *
   * @param t the first function argument
   * @param u the second function argument
   * @return the function result
  ...
  /**
   * Applies this function to the given argument, wrapping any thrown checked exceptions using the
   * given {@code exceptionWrapper}.
   *
   * @param t the first function argument
   * @param u the second function argument
  ...
  /**
   * Return a new {@link ThrowingBiFunction} where the {@link #apply(Object, Object)} method wraps
   ...
   */
  default ThrowingBiFunction<T, U, R> throwing(
  ...
  /**
   * Lambda friendly convenience method that can be used to create a {@link ThrowingBiFunction}
   * where the {@link #apply(Object, Object)} method wraps any checked exception thrown by the
  ...
  /**
   * Lambda friendly convenience method that can be used to create a {@link ThrowingBiFunction}
   * where the {@link #apply(Object, Object)} method wraps any thrown checked exceptions using the
   * given {@code exceptionWrapper}.
   *
   * <p>This method can be especially useful when working with method references. It allows you to
   * easily convert a method that throws a checked exception into an instance compatible with a
   ...
   * @return a new {@link ThrowingFunction} instance
   */
  static <T, U, R> ThrowingBiFunction<T, U, R> of(
      ThrowingBiFunction<T, U, R> function,
      BiFunction<String, Exception, RuntimeException> exceptionWrapper) {
