...
public class AnnotationsUtils {
    ...
    /**
     * Extracts the custom {@link NaftahFunction} representation from the {@link NaftahFn} annotation on the method.
     *
     ...
     * @param annotations One or more annotation classes to verify.
     * @return {@code true} if all specified annotations are present on the class, otherwise {@code false}.
     */
    @SafeVarargs
    ...
    /**
     * Extracts the custom {@link NaftahFunctionProvider} representation from the {@link NaftahFnProvider} annotation on the class.
     *
     * @param aClass The class annotated with {@link NaftahFnProvider}.
     * @return A {@link NaftahFunctionProvider} instance constructed from the annotation.
     */
