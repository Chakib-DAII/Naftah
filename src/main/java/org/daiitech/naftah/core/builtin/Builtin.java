...
public final class Builtin {
  ...
  @NaftahFn(
      ...
      parameterTypes = {Number.class, Number.class},
      returnType = Number.class)
  public <T extends Number> Number subtract(T x, T y) {
  ...
  @NaftahFn(
      ...
      parameterTypes = {Number.class, Number.class},
      returnType = Number.class)
  public <T extends Number> Number multiply(T x, T y) {
  ...
  @NaftahFn(
      ...
      parameterTypes = {Number.class, Number.class},
      returnType = Number.class)
  public <T extends Number> Number divide(T x, T y) {
  ...
  @NaftahFn(
      ...
      parameterTypes = {Number.class, Number.class},
      returnType = Number.class)
  public <T extends Number> Number modulo(T x, T y) {
