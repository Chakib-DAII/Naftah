...
public class DeclaredParameter {
    ...
    private DeclaredParameter(NaftahParser.ParameterDeclarationContext originalContext, String name, boolean constant,
    ...
    public static DeclaredParameter of(NaftahParser.ParameterDeclarationContext originalContext, String name, boolean constant,
                                       Object type, Object defaultValue) {
