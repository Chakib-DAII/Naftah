...
public class JulLoggerConfig {
  ...
  public static synchronized void initializeFromResources(String propertiesPath)
      throws IOException {
  ...
  /**
   * Initialize JUL logging from an external properties file path. This method is synchronized to
