...
يوضح هذا الملف كيفية **تعريف المتغيرات والثوابت** باستخدام **التعيينات النوعية** (Typed Assignments) في لغة **نفطة**،
...
| الاسم في نفطة     | النوع المقابل (بالإنجليزية) | الوصف                           |
|-------------------|-----------------------------|---------------------------------|
...
* الأعداد العشرية تفصل بين الجزء الصحيح والكسري بـ `،` بدلًا من `.` (وفق تنسيق نفطة).
* السلاسل النصية تدعم التضمين الديناميكي عبر عدة أنماط من القوالب `${}`، `{}`$، `{{}}`.
* تدعم نفطة أنواعًا مخصصة أو مؤهلة (`ا:ب:ت`) للتوسعة عبر الوحدات أو الحزم.
