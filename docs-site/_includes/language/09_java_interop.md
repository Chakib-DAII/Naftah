# ⚙️ التوافق مع Java (Java Interop) في لغة نفطة

هذا الملف يوضح كيفية **التعامل مع مكتبات جافا** في لغة **نفطة**، بما يشمل:
...
* **تحويل الأنواع بين نفطة وجافا**

---

## 📌 إنشاء الكائنات (Object Creation)

| نوع الكائن                    | الطريقة في نفطة                              | مثال عملي                                                                                   |
|-------------------------------|----------------------------------------------|---------------------------------------------------------------------------------------------|
| Object عام                    | `جافا:لغة:كائن()`                            | `ثابت كائن = جافا:لغة:كائن()`                                                               |
...
| Optional            | `orElse(defaultValue)`  | الحصول على القيمة أو قيمة افتراضية | `جافا:أدة:اختياري::فارغ_():::أو_لس("لغة نفطة")`            |
...
---*
استدعاء Objects.requireNonNull على قيمة فارغة
استدعاء Objects.requireNonNull(null) سيثير NullPointerException
---*
جافا:أدة:الكائنات::الاحتياجات_غير_فارغ(فارغ)
...
---*
ثابت قائمة تعيين [0؛0؛0]
جافا:أدة:صفائف::ملئ(قائمة؛1)

--- استدعاء نسخة محددة fill:15 على نفس القائمة
جافا:أدة:صفائف::ملئ:15(قائمة؛1)
...
---*
استدعاء Arrays.sort(قائمة_تسلسل_أحرف)، يرتب عناصر القائمة ترتيبًا تصاعديًا
---*
ثابت قائمة_تسلسل_أحرف تعيين ["ب"؛"أ"؛"ب"]
جافا:أدة:صفائف::هكذارت(قائمة_تسلسل_أحرف)

--- استدعاء نسخة محددة sort:3 على نفس القائمة
جافا:أدة:صفائف::هكذارت:3(قائمة_تسلسل_أحرف)

--- استدعاء نسخة محددة sort:17 على نفس القائمة
جافا:أدة:صفائف::هكذارت:17(قائمة_تسلسل_أحرف)
...
---*
ثابت قائمة تعيين [0؛0؛0]
جافا:أدة:بنى_المعطيات::ملئ(قائمة؛1)
...
java.util.Comparator::naturalOrder نداء بإستعمال ---
ثابت مقارن_الترتيب_الطبيعي تعيين جافا:أدة:مقارن::الطبيعية_الأمر()
جافا:أدة:بنى_المعطيات::مفي([1؛2؛1؛3]؛مقارن_الترتيب_الطبيعي)
جافا:أدة:بنى_المعطيات::مفي(["ب"؛"أ"؛"ب"؛"أ"]؛مقارن_الترتيب_الطبيعي)
جافا:أدة:بنى_المعطيات::مفي([’أ’؛’ب’؛’أ’؛’ب’]؛مقارن_الترتيب_الطبيعي)
جافا:أدة:بنى_المعطيات::مفي([حقيقي؛خاطئ؛صائب؛خاطئ]؛مقارن_الترتيب_الطبيعي)
جافا:أدة:بنى_المعطيات::مفي((1؛2؛1؛3)؛مقارن_الترتيب_الطبيعي)
جافا:أدة:بنى_المعطيات::مفي(#{خاطئ؛صائب}؛مقارن_الترتيب_الطبيعي)
...
ثابت قائمة تعيين [1؛2؛3]
جافا:أدة:بنى_المعطيات::العكس(قائمة)

java.util.Collections::rotate نداء ---
ثابت قائمة تعيين [1؛2؛3]
جافا:أدة:بنى_المعطيات::رومانياتات(قائمة؛1)
جافا:أدة:بنى_المعطيات::رومانياتات(قائمة؛2)

java.util.Collections::swap نداء ---
ثابت قائمة تعيين [1؛100؛0]
جافا:أدة:بنى_المعطيات::مقايضة(قائمة؛0؛2)

java.util.Collections::shuffle نداء ---
ثابت قائمة تعيين [1؛100؛0]
جافا:أدة:بنى_المعطيات::خلط(قائمة)
جافا:أدة:بنى_المعطيات::خلط(قائمة؛جافا:أدة:عشوائي())
جافا:أدة:بنى_المعطيات::خلط(قائمة؛جافا:أمن:مأمون_عشوائي())
...
---*
ثابت قائمة تعيين [1؛100؛0]
جافا:أدة:بنى_المعطيات::هكذارت(قائمة)
...
ثابت قائمة تعيين [1؛100؛0]
جافا:أدة:بنى_المعطيات::هكذارت(قائمة؛مقارن_الترتيب_الطبيعي)
...
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف:0("C:\\Program Files\\Java")

جافا:إن_آي_أو:ملف:الملفات::موجود(مسار)

java.nio.file.Files::notExists نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah")
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف:0("C:\\Program Files\\naftah")

جافا:إن_آي_أو:ملف:الملفات::لا_موجود(مسار)

java.nio.file.Files::isDirectory نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
جافا:إن_آي_أو:ملف:الملفات::هو_مدير(مسار)

java.nio.file.Files::isExecutable نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah\\bin\\naftah.sh")
جافا:إن_آي_أو:ملف:الملفات::هو_التنفيذ(مسار)

java.nio.file.Files::isHidden نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah\\bin\\naftah.sh")
جافا:إن_آي_أو:ملف:الملفات::هو_مخبأ(مسار)

java.nio.file.Files::isReadable نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
جافا:إن_آي_أو:ملف:الملفات::هو_إعادةادابل(مسار)

java.nio.file.Files::isWritable نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
جافا:إن_آي_أو:ملف:الملفات::هو_كاتب(مسار)

java.nio.file.Files::lines نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah\\bin\\naftah.sh")
جافا:إن_آي_أو:ملف:الملفات::خطوط(مسار)

java.nio.file.Files::list نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
جافا:إن_آي_أو:ملف:الملفات::القائمة(مسار)

java.nio.file.Files::walk نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\Java")
جافا:إن_آي_أو:ملف:الملفات::والألبانياك(مسار)
جافا:إن_آي_أو:ملف:الملفات::والألبانياك(مسار؛3)

java.nio.file.Files::readAllLines نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah\\bin\\naftah.sh")
جافا:إن_آي_أو:ملف:الملفات::إعادةاد_الألبانيال_خطوط(مسار)

java.nio.file.Files::readString نداء ---
ثابت مسار : جافا:إن_آي_أو:ملف:مسار تعيين جافا:إن_آي_أو:ملف:مسار::وف("C:\\Program Files\\naftah\\bin\\naftah.sh")
جافا:إن_آي_أو:ملف:الملفات::إعادةاد_سلسلة(مسار)
...
-- chained call with piping previous result if static method or calling on instance if instance method
ثابت أ : عدد_قصير_جدا تعيين جافا:لغة:الرياضيات::ابس(1):::أميكس(10)
ثابت ب : عدد_قصير تعيين جافا:لغة:الرياضيات::ابس(1):::أميكس(10):::أس(2)
...
2. **تحت_إسم / مثل**: يسمح بإعادة تسمية الدوال أو الكائنات لتسهيل الاستخدام في نفطة.
...
* يمكن استدعاء **الدوال الثابتة والمثيلة** من مكتبات جافا مباشرة داخل نفطة.
...
* أسماء الدوال في نفطة عربية مع إمكانية التعامل مع **الأرقام الصحيحة والعشرية** و**char/Character**.
