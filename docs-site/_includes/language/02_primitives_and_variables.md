...
| الاسم في نفطه | النوع المقابل (بالإنجليزية) | الوصف                                        |
|---------------|-----------------------------|----------------------------------------------|
| `مدة`         | `DURATION`                  | تمثيل مقدار زمني محدد، مثل 5 دقائق أو 2 ساعة |
| `فترة`        | `PERIOD`                    | تمثيل فترة زمنية بين تاريخين أو نقطتين       |
| `فترة_و_مدة`  | `PERIOD_DURATION`           | تمثيل مزيج من فترة زمنية ومقدار زمني         |
| `تاريخ`       | `DATE`                      | تمثيل تاريخ معين                             |
| `وقت`         | `TIME`                      | تمثيل وقت معين                               |
| `تاريخ_و_وقت` | `DATE_TIME`                 | تمثيل تاريخ ووقت معًا                        |
