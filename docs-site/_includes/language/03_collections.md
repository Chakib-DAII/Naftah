...
هذا الملف يشرح كيفية تعريف واستخدام بُنى المعطيات الأساسية في لغة نفطة: القوائم، التركيبات، المجموعات، والمصفوفات
الترابطية.
...
عند تنفيذ سكربت في نفطة، يتم تمرير الوسائط (arguments) كسلسلة من القيم من الخارج، ويُتاح الوصول إليها داخل السكربت عبر
...
#### 🧰 الاستخدام النموذجي في سكربت نفطة
