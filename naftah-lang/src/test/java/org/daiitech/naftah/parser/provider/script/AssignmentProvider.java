	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		return Stream
				.of(Arguments.of(true, """
					...
					Arguments.of(false, """
										متغير المدينة: هيكل تعيين {
										متغير الاسم: تسلسل_رموز تعيين "قبلي",
										متغير عدد_السكان: عدد تعيين 50000,
										متغير البلدة: كائن تعيين {
											متغير الاسم: تسلسل_حروف تعيين "سوق الأحد",
											متغير عدد_البيوت: عدد_طويل تعيين 400
										}
										}
										المدينة؟["ء"]:عدد_البيوت = 50
										المدينة؟["ء"]:عدد_البيوت
					...
					Arguments
							.of(true,
								...
								متغير ه : عدد_صحيح تعيين 2147483647
								متغير المدينة: كائن تعيين {
								متغير الاسم: تسلسل_حروف تعيين "قبلي",
								متغير عدد_السكان: عدد_صحيح تعيين 50000,
								متغير البلدة: هيكل تعيين {
									متغير الاسم: تسلسل_أحرف تعيين "سوق الأحد",
									متغير عدد_البيوت: عدد تعيين 400
								}
								}
