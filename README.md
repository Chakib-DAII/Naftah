...
| Topic                                                                                        | Description                                                                                                                                                       |
|----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 📘 [Keywords](./docs-site/_includes/language/01_keywords.md)                                 | Introduction to reserved words and special identifiers used in Naftah language.                                                                                   |
...
| 📙 [Java Interop](./docs-site/_includes/language/09_java_interop.md)                         | Using Java classes and methods within Naftah code; how to call, instantiate, and work with Java objects seamlessly.                                               |
| 📒 [Concurrency](./docs-site/_includes/language/10_concurrency.md)                           | Working with asynchronous functions, tasks, scopes, channels, and actors in Naftah; how to write concurrent and parallel code safely and efficiently.             |
| 📒 [Temporal](./docs-site/_includes/language/11_temporal.md)                                 | Working with dates, times, durations, and periods; support for multiple chronologies (ISO, Hijrah), time zones and offsets, and precise conversions between them. |
